...
- ライトモード: [https://your-worker.your-subdomain.workers.dev/svg](https://your-worker.your-subdomain.workers.dev/svg)
- ダークモード: [https://your-worker.your-subdomain.workers.dev/svg?theme=dark](https://your-worker.your-subdomain.workers.dev/svg?theme=dark)
- カスタムタイムゾーン: [https://your-worker.your-subdomain.workers.dev/svg?tz=America/New_York](https://your-worker.your-subdomain.workers.dev/svg?tz=America/New_York)
